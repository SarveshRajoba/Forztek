...
function VisionMission() {
    ...
    return (
        <div className="flex flex-col sm:flex-row h-auto sm:h-screen relative lg:min-h-screen">
            ...
            >
                <h1 className="text-4xl md:text-5xl sm:text-5xl font-bold lg:mr-20 md:mr-20 lg:mb-4 md:mb-4 sm:mb-0 sm:mr-0 tracking-wider">
                    Vision
                </h1>
            ...
            >
                <h1 className="text-4xl md:text-5xl sm:text-5xl font-bold lg:mr-9 md:mr-9 lg:mb-4 md:mb-4 sm:mb-0 sm:mr-0 tracking-wider">
                    Mission
                </h1>
                <div className="flex lg:-translate-x-20 md:-translate-x-20">
                    <Line />
