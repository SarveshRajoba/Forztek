...
const OurOffering = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-10 bg-[#201E43] min-h-screen">
      {/* Left Side: Title */}
...
// const OurOffering = () => {
//   return (
//     <div className="flex flex-col md:flex-row justify-between items-center p-10 bg-[#0E1E63] min-h-screen">
//       {/* Left Side: Title */}
//       <div className="flex flex-col items-start justify-center mb-10 md:mb-0 md:w-1/3">
//         <h1 className="text-5xl text-white font-bold mb-4 text-left">Our Offerings</h1>
//         <div className="w-16 h-1 bg-blue-400 mb-8"></div>
